...
try:
	...
	print R + '-------- 01144232272 --------'.center(44)
	print "   A _!!!!_ F".center(44)
	print '   H /  \   \ A'.center(44)
	print '  M  (<o><o>)  W'.center(44)
	print '  E  \>_db_</  Z'.center(44)
	print '   D   |vv|   Y'.center(44)
	print '   *  (__)  *'.center(44)
	print '------ 01144232272 ------'.center(44)
	print W + ' '
	print ('Ahmed Fawzy Elmetenawy').center(44)
	print ' '
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Fawzy & Yousef
    Name       joker 'Open Source Information Facebook'
    CodeName   joker
    version    full version
    Date       21/05/2019 09:35:12
    Team       Fawzy & Yousef
    Email      af456332@gmail.com
               ahmedfwzy1@yahoo.com
